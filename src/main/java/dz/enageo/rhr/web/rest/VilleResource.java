...
import dz.enageo.rhr.domain.Ville;
import dz.enageo.rhr.repository.VilleRepository;
...
/**
 * REST controller for managing {@link dz.enageo.rhr.domain.Ville}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class VilleResource {
    ...
    public ResponseEntity<Ville> partialUpdateVille(
        ...
        Optional<Ville> result = villeRepository
            ...
            .map(existingVille -> {
                if (ville.getLibelle() != null) {
                    existingVille.setLibelle(ville.getLibelle());
                }
