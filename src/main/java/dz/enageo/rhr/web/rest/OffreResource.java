...
/**
 * REST controller for managing {@link dz.enageo.rhr.domain.Offre}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OffreResource {
    ...
    public ResponseEntity<Offre> partialUpdateOffre(
        ...
        Optional<Offre> result = offreRepository
            ...
            .map(existingOffre -> {
                if (offre.getNumeroOffre() != null) {
                    existingOffre.setNumeroOffre(offre.getNumeroOffre());
                }
                if (offre.getDateOffre() != null) {
                    existingOffre.setDateOffre(offre.getDateOffre());
                }
                if (offre.getDateDepot() != null) {
                    existingOffre.setDateDepot(offre.getDateDepot());
                }
                if (offre.getEtatOffre() != null) {
                    existingOffre.setEtatOffre(offre.getEtatOffre());
                }
                if (offre.getTypeOffre() != null) {
                    existingOffre.setTypeOffre(offre.getTypeOffre());
                }
                if (offre.getSingnataire() != null) {
                    existingOffre.setSingnataire(offre.getSingnataire());
                }
