...
/**
 * REST controller for managing {@link dz.enageo.rhr.domain.Personne}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Personne> partialUpdatePersonne(
        ...
        Optional<Personne> result = personneRepository
            ...
            .map(existingPersonne -> {
                ...
                if (personne.getNumeroInscription() != null) {
                    existingPersonne.setNumeroInscription(personne.getNumeroInscription());
                }
                if (personne.getDateOrientation() != null) {
                    existingPersonne.setDateOrientation(personne.getDateOrientation());
                }
