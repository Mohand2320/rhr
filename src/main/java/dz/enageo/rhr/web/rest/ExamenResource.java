...
/**
 * REST controller for managing {@link dz.enageo.rhr.domain.Examen}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ExamenResource {
    ...
    public ResponseEntity<Examen> partialUpdateExamen(
        ...
        Optional<Examen> result = examenRepository
            ...
            .map(existingExamen -> {
                if (examen.getDatePrevue() != null) {
                    existingExamen.setDatePrevue(examen.getDatePrevue());
                }
                if (examen.getDateExamen() != null) {
                    existingExamen.setDateExamen(examen.getDateExamen());
                }
                if (examen.getEtat() != null) {
                    existingExamen.setEtat(examen.getEtat());
                }
                if (examen.getLieuExamen() != null) {
                    existingExamen.setLieuExamen(examen.getLieuExamen());
                }
                if (examen.getMiniDossier() != null) {
                    existingExamen.setMiniDossier(examen.getMiniDossier());
                }
